"""
Django settings for django_filess project.
...
ROOT_URLCONF = 'django_filess.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django_filess.context_processors.project_context'
            ],
        },
    },
]

WSGI_APPLICATION = 'django_filess.wsgi.application'
